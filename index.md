...
There are many instances in which international users may not have access to software that they otherwise would have been interested in supporting due to restrictions in software distribution, like geoblocking. There are many other instances, as Patrick Klug of Greenheart Games noted, in which individuals can’t make a legal purchase because of payment-issues or who genuinely cannot afford the game. [1] Regardless of the specific reason, the circumstances surrounding these people have forced them into employing methods to circumvent the system. As such, the ethicality of pirating software has been translated into a zero-sum game. Their actions can be justified as their only means of obtaining said content.

However, of the users who have chosen to exploit the cracked version despite unhindered access to purchase the paid version, many are simply enabled by the ease of such an action. Some recent trends in technology, namely the surging levels of global interconnectedness through telecommunications networks and the growing accessibility to online distribution platforms, has led to the proliferation of cracked software. To many users, the negative consequences aren’t immediately apparent and the current technology has empowered them to the point that pirating software could be accomplished from the comfort of their own living space. A certain level of ignorance regarding the harmful effects that their actions have resulted upon the developers may be promulgated from an emphasis on a self-serving, duty-based framework and the seemingly innocuous nature of its immediate implications. Furthermore, as they suspect that countless other users will opt to buy the content, many users believe that their action is effectively negligible.

Our group believes that software piracy damages both the developers and the users. One vital issue that arises from piracy is the potentially immense amount of lost money for the software company. For Greenheart Games, a small game development team, within one day of the release of their game *Game Dev Tycoon*, the game was purchased genuinely 214 times and cracked 3104 times. [1] That means that 93.6% of day-one users played through a cracked version. And as the game was sold for eight dollars, Greenheart Games effectively lost a total of more than two-dozen-thousand dollars of income in a single day. From the user’s side, pirating software poses problems as well, especially in the realm of cybersecurity. The anonymously sourced contents of cracked software may hide viruses and other forms of vulnerability exploitations. These can lead to untold headaches for the user, whether it be the theft of personal data or an unexplained slow-down of computer processing.

###### [1]  Patrick, What happens when pirates play a game development simulator and then go bankrupt because of piracy?, Greenheart Games Blog, April 29, 2013.
